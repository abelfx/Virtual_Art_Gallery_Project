...
export const setupScene = () => {
  ...
  renderer = new THREE.WebGLRenderer({ antialias: true }); // create a WebGLRenderer and set its antialias property to true to enable antialiasing which smooths out the edges of what is rendered
  ...
  renderer.setClearColor(0x87CEEB, 1); // set the background color of the renderer to sky blue
  ...
  // Use OrbitControls instead of PointerLockControls for better gallery navigation
